...
# print(predict_language(m, cv, "Ultime notizie, sport, TV, radio e molto altro ancora. La BBC informa, educa e intrattiene, ovunque tu sia, qualunque sia la tua età."))